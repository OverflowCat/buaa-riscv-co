lw x5, 0(x0)            # 将内存地址 0(x0) == 0 处的值 (01) 加载到寄存器 x5
...
lw x13, 12(x12)         # x13 = mem[4 + 12] == mem[16] == 8
sub x13, x13, x6        # x13 -= x6 == 6
beq x13, x11, -44       # 如果x13等于x11，跳转到当前指令前的44个指令偏移(6 != 2)
add x11, x11, x6        # x11 += x6 == 2 + 2 == 4
sub x13, x13, x6        # x13 -= x6 == 6 - 2 == 4
